...
// var space buat misahin jawaban di konsol
var space = '\n';
console.log(space);
...
var secondWord = word2[3] + word2[4] + word2[5] + word2[6] + word2[7] + word2[8] + word2[9] + word2[10] + word2[11] + word2[12] + word2[13];
var thirdWord = word2[word2.length - 10] + word2[word2.length - 9]; 
var fourthWord = word2[word2.length - 7] + word2[word2.length - 6];
var fifthWord = word2[word2.length - 4] + word2[word2.length - 3] + word2[word2.length - 2] + word2[word2.length - 1];
